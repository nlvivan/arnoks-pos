...
import { UserOutlined, VideoCameraOutlined, UploadOutlined, DashboardOutlined } from '@ant-design/icons-vue';
        ...
        <div class="min-h-screen bg-gray-100">
            <a-layout>
                <a-layout-sider :style="{
                    ...
                    <a-menu class="bg-gray-900" v-model:selectedKeys="selectedKeys" theme="dark" mode="inline">
                ...
                <a-layout>
                    <a-layout-header :style="{ background: '#fff', padding: '4px' }">
                        <a-dropdown :trigger="['click']" class="flex items-center float-right" placement="bottomRight">
                            <div>
                                <button type="button"
                                    class="flex items-center rounded-full bg-white text-sm focus:outline-none">
                                    <span class="mr-3 font-medium">{{ user.name }}</span>
